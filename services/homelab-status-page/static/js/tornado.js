...
function init() {
    ...
    const perlinTexture = textureLoader.load( '/static/images/blog/rgb-256x256.png' );
    ...
    emissiveMaterial.outputNode = Fn(function(){
    ...
    renderer.setAnimationLoop( () => {
        ...
        hue += .1;
        //sin(Math.random() * 100);
        emissiveColor.value.setHSL(hue / 360, 1, 0.5); 
        animate();
    } );
